        ...
        <nav class="navbar navbar-expand-lg navbar-light fixed-top shadow-sm" id="mainNav">
            <div class="container px-5">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    ...
                    <a class="btn ktx-btn-yellow px-3 mb-2 mb-lg-0 rounded-pill" href="{{ route('contact') }}">
                ...
                <div class="row gx-5 align-items-center">
                    <div class="col-lg-6">
                        ...
                        <div class="mb-5 mb-lg-0 text-center text-lg-start">
                            <h1 class="display-2 lh-1 mb-3">Des moyens de transport sûrs et rapides</h1>
                            <p class="lead fw-normal text-muted mb-5">
                                Téléchargez l'appli KinTaxi, et commandez un véhicule pour vous transporter où vous voulez.
                            </p>
